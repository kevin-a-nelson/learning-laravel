        ...
        <form class="form-container" @submit.prevent="onSubmit" novalidate>
            <fieldset>
                ...
                <div>
                    ...
                    <input v-model="postTitle" type="name" class="form-control" id="exampleInputName1"
                        aria-describedby="nameHelp">
                </div>
                <div>
                    <label for="exampleTextarea" class="form-label mt-4">Text</label>
                    <textarea v-model="postText" class="form-control" id="exampleTextarea" rows="3"></textarea>
                </div>
        ...
        async createPost() {
            ...
            await axios.post(url, newPost)
                .then(response => {
                    ...
                    else { this.createPostFailed = true }
                }).catch(error => {
                    this.createPostFailed = true
                    console.log(error)
                })
